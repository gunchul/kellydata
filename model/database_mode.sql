...
-- -----------------------------------------------------
-- Table `kellydata`.`interest`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kellydata`.`interest` (
  `added_date` DATETIME NULL,
  `date` DATETIME NOT NULL,
  `bank` VARCHAR(64) NOT NULL,
  `fixed_owner_1year_rate` DOUBLE NULL,
  `fixed_owner_2year_rate` DOUBLE NULL,
  `fixed_owner_3year_rate` DOUBLE NULL,
  `fixed_invest_1year_rate` DOUBLE NULL,
  `fixed_invest_2year_rate` DOUBLE NULL,
  `fixed_invest_3year_rate` DOUBLE NULL,
